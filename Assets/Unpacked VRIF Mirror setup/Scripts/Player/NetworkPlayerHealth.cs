...
namespace BNG {
    public class NetworkPlayerHealth : NetworkBehaviour
    {
        ...
        private void RpcSpawnRagdoll() {
            ...
            // Loop through and match all the bones / rotations to match the player's last rotations
        ...
        private void MatchRagdollBones(Transform sourceRig, Transform ragdollRig) {
